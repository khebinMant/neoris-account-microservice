...
import com.neoris.account.account.seeders.AccountSeeder;
import com.neoris.account.config.AccountConfiguration;
import com.neoris.account.movements.seeders.MovementsSeeder;
...
@EnableFeignClients(basePackages = "com.neoris.account.feign")
public class AccountApplication implements CommandLineRunner {

    @Autowired
    MovementsSeeder movementsSeeder;
    ...
    public void run(String... args) throws Exception {
        ...
        accountSeeder.fillStartAccounts();
    }
}
